...
function LoginBox() {
    ...
    return (
        <>
            ...
            <input type="email" id="email" class="client-info" required onChange={(e)=>{setEmail(e.target.value)}} />
            <label for="email" className="label">Email</label>
            <input type="password" id="password" class="client-info" required onChange={(e)=>{setPassword(e.target.value)}} />
